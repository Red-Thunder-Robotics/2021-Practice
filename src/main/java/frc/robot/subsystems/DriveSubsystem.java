...
public class DriveSubsystem extends SubsystemBase {
   ...
   */
   ...
   public DifferentialDrive differentialRocketLeaugeDrive = new DifferentialDrive(leftMotor, rightMotor);


   public void RocketLeaugeDrive(double speed, double turn){
     differentialRocketLeaugeDrive.arcadeDrive(xSpeed, zRotation);
   }
